...
function clickAddNewWhiteBlock() {
	CONFIG_block_color = '#e3e8e6';
	CONFIG_block_font_color = '#000';
	CONFIG_block_stroke_color = '#000';
	CONFIG_focus_stroke_color = '#000'; 
	CONFIG_block_part_header_font_color = '#000';
	CONFIG_block_name_font_color = '#000';
	CONFIG_stereotype_font_color = '#000';
	mySel = null;
	var width = 0; 
	var height = 0;
	newModel_startX = newModel_startX + 10; 
	newModel_startY = newModel_startY + 10;

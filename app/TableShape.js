...
TableShapePurple = draw2d.shape.layout.VerticalLayout.extend({

	NAME: "TableShapePurple",
     ...
     setPersistentAttributes : function(memento)
     {
         ...
         if(typeof memento.entities !== "undefined"){
             $.each(memento.entities, $.proxy(function(i,e){
                 var entity =this.addEntity(e.text);
                 entity.id = e.id;
                 entity.getInputPort(0).setName("input_");
                 entity.getOutputPort(0).setName("output_");
             },this));
         }
